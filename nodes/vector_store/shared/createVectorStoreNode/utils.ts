 ...
 * @param fields - Array of node property definitions to transform
 * @param mode - Single mode or array of modes when fields should be visible
 * @returns Transformed field definitions with displayOptions added
 */
 ...
 * @param args - Vector store node constructor arguments
 * @returns True if update operation is supported
 */
 ...
 * @param args - Vector store node constructor arguments
 * @returns Array of enabled operation mode options for UI display
 */
